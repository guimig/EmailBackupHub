        ...
        <head>
            ...
            <style>
                ...
                #searchBox {
                    ...
                    max-width: 500px;
                    border-radius: 6px;
                    border: 1px solid #484f58;  /* Borda cinza escura */
                    background-color: #0d1117;  /* Fundo preto acinzentado */
                    color: #c9d1d9;  /* Texto claro */
                ...
                #searchBox::placeholder {
                    color: #6e7681; /* Cinza claro para o texto do placeholder */
                }
                #searchBox:focus {
                    border-color: #1f6feb; /* Azul do GitHub para foco */
                    box-shadow: 0 0 5px rgba(31, 111, 235, 0.8); /* Brilho sutil */
                }
                /* Responsividade */
