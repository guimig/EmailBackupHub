    ...
    html_content = """
        ...
        <head>
            ...
            <style>
                ...
                .folder {
                    margin-top: 20px;
                    background-color: #444;  /* Fundo mais escuro para pastas */
                    padding: 15px;
                    border-radius: 8px;
                    box-shadow: 0 2px 5px rgba(0, 0, 0, 0.3);
                    border-left: 5px solid #008080;  /* Cor verde mais forte */
                }
                .folder h2 {
                    color: #00b5b5;  /* Verde mais suave */
                    font-size: 1.5em;
                    margin-bottom: 10px;
                }
                .links {
                ...
                a:hover {
                    ...
                    color: #006666;  /* Tom mais escuro de verde */
                }
                .footer {
                    margin-top: 30px;
                    text-align: center;
                    color: #888;  /* Texto do rodapé em cinza claro */
                }
